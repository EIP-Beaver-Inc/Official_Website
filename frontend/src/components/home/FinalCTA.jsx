    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background:
                        'radial-gradient(700px 360px at 80% 20%, hsla(10, 60%, 40%, 0.08) 0%, transparent 60%), linear-gradient(180deg, hsl(120 28% 92%) 0%, hsl(120 33% 94%) 100%)',
                }}
            />
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-32 text-center">
                <div data-animate="fade-up" className="label-caps mb-6">
                    <span className="text-[hsl(var(--primary))]">05</span> · Passer à l’action
                </div>
                <h2
                ...
                <div data-animate="fade-up" className="mt-10 flex flex-wrap justify-center gap-3 sm:gap-4">
                    <DemoDialog
                        triggerClassName="inline-flex items-center justify-center rounded-full bg-[hsl(var(--primary))] hover:bg-[hsl(10_62%_36%)] text-[hsl(var(--primary-foreground))] px-6 sm:px-7 h-12 sm:h-[54px] text-sm sm:text-base font-medium transition-colors shadow-[0_8px_24px_rgba(168,65,42,0.18)]"
